...
const AdminLogin = () => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row items-center md:px-14 px-6 relative h-screen justify-center md:gap-6 gap-2 p-4 bg-[#2B2738] text-white">
        <div
          ref={blink}
        ...
        <div className="md:w-[55%] relative h-full bg-no-repeat overflow-hidden   left  rounded-3xl md:p-8 p-3">
          <img
        ...
        <div className="md:w-[45%] h-full right md:p-14">
          <div>
            ...
            >
              ...
              <div>
                <label htmlFor="pass" className="p-1">
                  Password
                </label>
